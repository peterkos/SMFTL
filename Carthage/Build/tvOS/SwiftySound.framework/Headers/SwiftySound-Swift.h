...
- (BOOL)prepare SWIFT_WARN_UNUSED_RESULT;
- (BOOL)playWithNumberOfLoops:(NSInteger)numberOfLoops completion:(void (^ _Nullable)(BOOL))completion SWIFT_WARN_UNUSED_RESULT;
