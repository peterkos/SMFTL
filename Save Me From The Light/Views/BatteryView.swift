...
//
//  Created by Peter Kos on 2/12/18.
...
class BatteryView: UIView {
	...
	override func draw(_ rect: CGRect) {
		...
		let batteryShape = CAShapeLayer()
		batteryShape.backgroundColor = UIColor.black.cgColor
		batteryShape.path = drawBatteryShape()
		
		self.layer.addSublayer(batteryShape)
		
		
	}
	
	func drawBatteryShape() -> CGPath {
